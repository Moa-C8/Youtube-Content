...
def switchLight(id=1,status='Off'):
    ...
    try:
        ...
        print("probleme switchlight avec la requete verifier l'url")
    else:
...
def getStatusDomo(id=1):
    ...
    try:
        ...
        print("probleme getStatus avec la requete verifier l'url")
    else:
        data = r.json()
...
def getListDomo():
    ...
    try:
        ...
        print("probleme getlist avec la requete verifier l'url")
    else:
        data = r.json()
        msg = ""
